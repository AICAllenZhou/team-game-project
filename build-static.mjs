...
for(const file of ['index.html','style.css','game.js','game-loop.js','render-batches.js','weapon-pose.js','weapon-audio.js','simulation.mjs','skeet.mjs','skeet-view.js','weapons.mjs','shotgun-view.js','shell-physics.js']){
