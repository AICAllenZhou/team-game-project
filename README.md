...
Shots launch a visible glowing round immediately. Your confirmed hits show a large outlined screen marker at the projected impact location, including floor, fence, stand, target and player hits. The marker holds full brightness, drifts outward by up to 22 pixels and fades after 0.9 seconds; it stays readable at any distance. Sky misses have no marker. The visible flight uses elapsed time and lasts at least 50 ms for close shots; multiplayer confirms the impact before displaying its marker. The wrist has a stronger upward impulse with spring recovery.
